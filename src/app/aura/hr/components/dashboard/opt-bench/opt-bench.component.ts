...
@Component({
  selector: 'app-opt-bench',
  templateUrl: './opt-bench.component.html',
  styleUrls: ['./opt-bench.component.scss']
})
export class OptBenchComponent implements OnInit {
  ...
  countsDataGridsPanelConfig: DetailsConfig = {
    ...
    columns: [
      ...
      {
        headerDisplay: 'OPT Start Date',
        key: 'issueDate',
      },
      {
        headerDisplay: 'OPT End Date',
        key: 'expiryDate',
      },
    ],
    tableData: null,
